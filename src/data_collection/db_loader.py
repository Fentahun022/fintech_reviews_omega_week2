...
def main():
    print("--- Starting Robust Database Loading Process (Task 3) ---")
    ...
    if connection:
        try:
            with connection.cursor() as cursor:
                ...
                connection.commit()
                print(f"\n✅ Transaction committed. {num_inserted} new records were inserted into the REVIEWS table.")
                print("✅ KPI Met: Working connection + insert script is implemented.")
